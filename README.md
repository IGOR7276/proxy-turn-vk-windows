...
Форк [amurcanov/proxy-turn-vk-android](https://github.com/amurcanov/proxy-turn-vk-android) (серверная часть) с полностью переписанным десктопным UI на Wails (Go + React).
